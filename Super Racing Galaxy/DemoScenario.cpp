...
Scenario ScenarioCreator::CreateDemoScenario()
{
...

	{
		...
		planete2->addElement(new Scenery(Transform<>::BlenderToCookie({ -0.27384960651397705f, 0.21621567010879517f, 0.48919254541397095f }, { 0.0831971988081932f, 0.16599443554878235f, 0.16599442064762115f }, { -0.4409595727920532, 0.3152017891407013, -0.0561874620616436, -0.8384780287742615 }), "graphics/meshs/stalagmite.obj", L"graphics/textureDDS/stalagmiteTexture.dds"));
		planete2->addElement(new Scenery(Transform<>::BlenderToCookie({ -0.17411981523036957f, -0.29998770356178284f, 0.49205321073532104f }, { 0.08319717645645142f, 0.16599445044994354f, 0.16599449515342712f }, { 0.009300482459366322, 0.15023557841777802, 0.3078649938106537, -0.9394476413726807 }), "graphics/meshs/stalagmite.obj", L"graphics/textureDDS/stalagmiteTexture.dds"));
		planete2->addElement(new Scenery(Transform<>::BlenderToCookie({ -0.5098689794540405f, 0.20080772042274475f, 0.08136537671089172f }, { 0.08319719135761261f, 0.16599445044994354f, 0.16599445044994354f }, { -0.32138070464134216, 0.6952767968177795, 0.11700895428657532, -0.6321499347686768 }), "graphics/meshs/stalagmite.obj", L"graphics/textureDDS/stalagmiteTexture.dds"));
		...
		planete2->addElement(new Scenery(Transform<>::BlenderToCookie({ -0.16026319563388824f, -0.39200156927108765f, 0.3946479856967926f }, { 0.05288288742303848f, 0.10576575249433517f, 0.10576573014259338f }, { -0.018986660987138748, -0.15560877323150635, -0.402644544839859, 0.9018329977989197 }), "graphics/meshs/stalagmite.obj", L"graphics/textureDDS/stalagmiteTexture.dds"));
		planete2->addElement(new Scenery(Transform<>::BlenderToCookie({ 0.2988681197166443f, 0.4339793026447296f, 0.10344928503036499f }, { 0.08318585157394409f, 0.16637162864208221f, 0.1663716435432434f }, { 0.7882840037345886, -0.5171591639518738, 0.3234269320964813, -0.08093193173408508 }), "graphics/meshs/stalagmite.obj", L"graphics/textureDDS/stalagmiteTexture.dds"));
		...
		planete2->addElement(new Scenery(Transform<>::BlenderToCookie({ -0.30313631892204285f, 0.4430913031101227f, -0.1527092456817627f }, { 0.08318577706813812f, 0.16637158393859863f, 0.1663716584444046f }, { 0.5232884883880615, -0.3152288794517517, -0.7363483309745789, -0.29084575176239014 }), "graphics/meshs/stalagmite.obj", L"graphics/textureDDS/stalagmiteTexture.dds"));
		planete2->addElement(new Scenery(Transform<>::BlenderToCookie({ -0.14546148478984833f, 0.19108201563358307f, 0.5094689130783081f }, { 0.04999832436442375f, 0.0999966710805893f, 0.0999966412782669f }, { 0.43869760632514954, -0.027426747605204582, 0.025848407298326492, 0.8978442549705505 }), "graphics/meshs/stalagmite.obj", L"graphics/textureDDS/stalagmiteTexture.dds"));
		planete2->addElement(new Scenery(Transform<>::BlenderToCookie({ 0.38695427775382996f, 0.01456817053258419f, 0.541825532913208f }, { 0.17599159479141235f, 0.35198312997817993f, 0.3519833981990814f }, { 0.950188398361206, -0.040108662098646164, 0.3047522008419037, -0.051571570336818695 }), "graphics/meshs/stalagmite.obj", L"graphics/textureDDS/stalagmiteTexture.dds"));
