...
for obj in objects:
    if(obj.parent):
        ...
        if(objName == "pisteAtterrissage"):
            ...
            f.write("\tGoal *goal = new Goal(Transform<>::BlenderToCookie({ " + str(obj.location[0]) + "f, " + str(obj.location[1]) + "f, " + str(obj.location[2]) + "f }, { " + str(obj.scale[0]) + "f, " + str(obj.scale[1]) + "f, " + str(obj.scale[2]) + "f }, { " + str(obj.rotation_quaternion[0]) + ", " + str(obj.rotation_quaternion[1]) + ", " + str(obj.rotation_quaternion[2]) + ", " + str(obj.rotation_quaternion[3]) + " }), \"graphics/meshs/trophee.obj\", L\"graphics/textureDDS/tropheeTexture.dds\", \"graphics/meshs/hitBox/hitBoxTrophee.obj\");\n")
